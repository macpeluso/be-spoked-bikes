...
(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        tableClass: "ui stackable table jsgrid-table",
        ...
        render: function () {
            ...
            if (this.autoload) {
                ...
                this._callEventHandler(this.onRendered);
        ...
        editItem: function (item, grid) {
            var $row = this.rowByItem(item);
            if ($row.length) {
                this._editRow($row, grid);
            }
        },
        ...
        _editRow: function ($row, grid) {
            ...
            var $editRow = this._createEditRow(item, grid);
        ...
        _createEditRow: function (item, grid) {
            if ($.isFunction(this.editRowRenderer)) {
                return $(this.renderTemplate(this.editRowRenderer, this, { item: item, itemIndex: this._itemIndex(item) }));
            }

            var $result = $("<tr>").addClass(this.editRowClass + ' ' + 'ui form');

            this._eachField(function (field) {
                var fieldValue = this._getItemFieldValue(item, field);

                if (field.type === "KmsButtonGroup") {
                    var cell = this._prepareCell("<td>", field, "editcss")
                    var div = $("<div>").addClass('ui icon buttons')

                    var cancelBtn = $("<button>").attr("type", "button").addClass("ui button inverted")

                    var cancelIcon = $("<i>").addClass('far fa-times fa-fw icon small').css('color', 'rgb(224, 1, 4)')

                    cancelBtn.on("click", function (e) {
                        grid.cancelEdit(item);
                        e.stopPropagation();
                    });
                    cancelBtn.append(cancelIcon);

                    var submitBtn = $("<button>").attr("type", "button").addClass("ui button inverted")


                    var submitIcon = $("<i>").addClass('far fa-check fa-fw icon small').css('color', '#2dbd00')
                    ...
                    this._prepareCell("<td>", field, "editcss")
                        .append(this.renderTemplate(field.itemTemplate, field, { value: fieldValue, item: item }))
                        .appendTo($result);
                }
            });
        ...
        _updateRow: function ($updatingRow, editedItem) {
            ...
            return this._controllerCall("updateItem", updatedItem, args.cancel, function (loadedUpdatedItem) {
                ...
                if (this.find) {
                    for (var i = 0; i < this.editFields.length; i++) {
                        $('#' + updatedItem[this.find]).find('input').val(editedItem[this.editFields[i]])
                    }
                }
...
(function (jsGrid, $, undefined) {
    ...
    LoadIndicator.prototype = {
        ...
        _initLoadPanel: function () {
            this._loadPanel = $('<div class="modal fade in jsgrid-load-panel">' +
            ...
            var actualWidth = this._container.outerWidth();
            var actualHeight = this._container.outerHeight();
...
(function (jsGrid, $, undefined) {
    ...
    PageLoadingStrategy.prototype = {
        ...
        lastDisplayIndex: function () {
                var data = this._grid.option("data");
            return data ? this._grid.option("data").length : 0;
        },
        ...
        finishLoad: function (loadedData) {
            this._itemsCount = loadedData.length;
            this._grid.option("data", loadedData);
        },
...
(function (jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        editButtonClass: "kmsgrid-edit-button btn list-btn",
        editButtonIcon: "fas fa-pen",
        deleteButtonClass: "kmsgrid-delete-button btn list-btn",
        deleteButtonIcon: "fas fa-trash",
        ...
        _createModeSwitchButton: function () {
            ...
            var $button = this._createGridButton(this.modeButtonClass, "", this.custom, "", function (grid, e) {
        ...
        _createEditButton: function (item) {
            return this._createGridButton(this.editButtonClass, this.editButtonTooltip, this.custom, this.editButtonIcon, function (grid, e) {
                grid.editItem(item, grid);
                e.stopPropagation();
            });
        },

        _createDeleteButton: function (item) {
            return this._createGridButton(this.deleteButtonClass, this.deleteButtonTooltip, this.custom, this.deleteButtonIcon, function (grid, e) {
        ...
        _createSearchButton: function () {
            return this._createGridButton(this.searchButtonClass, this.searchButtonTooltip, this.custom, "", function (grid, e) {
                grid.search();
            });
        },

        _createClearFilterButton: function () {
            return this._createGridButton(this.clearFilterButtonClass, this.clearFilterButtonTooltip, this.custom, "", function (grid, e) {
                grid.clearFilter();
            });
        },

        _createInsertButton: function () {
            return this._createGridButton(this.insertButtonClass, this.insertButtonTooltip, this.custom, "", function (grid, e) {
        ...
        _createUpdateButton: function () {
            return this._createGridButton(this.updateButtonClass, this.updateButtonTooltip, this.custom, "", function (grid, e) {
                grid.updateItem();
                e.stopPropagation();
            });
        },
        ...
        _createCancelEditButton: function () {
            return this._createGridButton(this.cancelEditButtonClass, this.cancelEditButtonTooltip, this.custom, "", function (grid, e) {
                grid.cancelEdit();
                e.stopPropagation();
            });
        },

        _createGridButton: function (cls, tooltip, custom, icon, clickHandler) {
            var grid = this._grid;
            var button = $("<button>")
                .addClass(cls)
                .attr({
            ...
            if (custom === true) {
                ...
                button.append(icon).attr("data-content", tooltip)
            }
